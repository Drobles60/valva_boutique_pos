...
CREATE TABLE `compras` (
  `id` int NOT NULL AUTO_INCREMENT,
  `numero_compra` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proveedor_id` int unsigned NOT NULL,
  `factura_numero` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha` date NOT NULL,
  `fecha_vencimiento` date DEFAULT NULL,
  `tipo_pago` enum('contado','credito','mixto') COLLATE utf8mb4_unicode_ci DEFAULT 'contado',
  `subtotal` decimal(12,2) DEFAULT '0.00',
  ...
  `estado` enum('borrador','confirmada','anulada') COLLATE utf8mb4_unicode_ci DEFAULT 'borrador',
  `usuario_id` int unsigned DEFAULT NULL,
...
-- Dump completed on 2026-02-24 23:10:12
