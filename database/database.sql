...
INSERT INTO `categorias_padre` VALUES (1,'PANTALON','cualquier tipo de pantalon',1,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(2,'BLUSA','Cualquier tipo de blusa',2,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(3,'CONJUNTO','Prendas que se venden como una sola',3,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(4,'FALDAS','Faldas de diversos estilos',4,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(5,'SHORTS','Toda prenda ',5,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(6,'VESTIDOS','Todas clase de vestidos',6,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(7,'BOLSOS','Bolsos de diversos tipos',7,'activo','2026-01-16 03:26:03','2026-02-26 03:24:43'),(9,'BAGGI',NULL,0,'inactivo','2026-02-25 03:14:59','2026-02-26 01:36:14'),(10,'PACO',NULL,0,'activo','2026-02-26 03:10:31','2026-02-26 03:10:31');
...
CREATE TABLE `compras` (
  `id` int NOT NULL AUTO_INCREMENT,
  `numero_compra` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proveedor_id` int unsigned NOT NULL,
  `factura_numero` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha` date NOT NULL,
  `fecha_vencimiento` date DEFAULT NULL,
  `tipo_pago` enum('contado','credito','mixto') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'contado',
  `subtotal` decimal(12,2) DEFAULT '0.00',
  ...
  `estado` enum('borrador','confirmada','anulada') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'borrador',
  `usuario_id` int unsigned DEFAULT NULL,
...
CREATE TABLE `kardex` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `producto_id` int unsigned NOT NULL,
  `tipo_movimiento` enum('entrada_compra','entrada_devolucion','entrada_ajuste','salida_venta','salida_devolucion','salida_merma','salida_ajuste','ajuste_manual','cambio_precio','cambio_estado','inventario_inicial') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `saldo_costo` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT 'Valor acumulado (saldo_cantidad × precio_compra)',
  ...
  `campo_precio` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Campo modificado: precio_compra, precio_venta, precio_minimo',
  ...
  `referencia_doc` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Número de documento (factura, nota, etc.)',
  `usuario_id` int unsigned NOT NULL COMMENT 'Quién realizó el movimiento',
  `motivo` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Descripción o justificación',
  `observaciones` text COLLATE utf8mb4_unicode_ci COMMENT 'Notas adicionales',
  `fecha_movimiento` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_kardex_producto` (`producto_id`),
  KEY `idx_kardex_tipo` (`tipo_movimiento`),
  KEY `idx_kardex_fecha` (`fecha_movimiento`),
  KEY `idx_kardex_compra` (`compra_id`),
  KEY `idx_kardex_venta` (`venta_id`),
  KEY `idx_kardex_usuario` (`usuario_id`),
  KEY `idx_kardex_prod_fecha` (`producto_id`,`fecha_movimiento`),
  CONSTRAINT `fk_kardex_compra` FOREIGN KEY (`compra_id`) REFERENCES `compras` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_kardex_venta` FOREIGN KEY (`venta_id`) REFERENCES `ventas` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Kardex de inventario — registro histórico de todos los movimientos de productos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `kardex` VALUES (1,1,'inventario_inicial',1,0,1,50000.00,60000.00,55000.00,50000.00,1,50000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(2,2,'inventario_inicial',1,0,1,80000.00,100000.00,95000.00,80000.00,1,80000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(3,3,'inventario_inicial',1,0,1,50000.00,100000.00,95000.00,50000.00,1,50000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(4,10,'inventario_inicial',1,0,1,30000.00,60000.00,50000.00,30000.00,1,30000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(5,11,'inventario_inicial',1,0,1,100000.00,150000.00,145000.00,100000.00,1,100000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(6,12,'inventario_inicial',12,0,12,100000.00,150000.00,145000.00,1200000.00,12,1200000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(7,13,'inventario_inicial',1,0,1,50000.00,85000.00,80000.00,50000.00,1,50000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(8,14,'inventario_inicial',1,0,1,50000.00,85000.00,80000.00,50000.00,1,50000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(9,18,'inventario_inicial',1,0,1,50000.00,90000.00,85000.00,50000.00,1,50000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(10,19,'inventario_inicial',2,0,2,50000.00,90000.00,85000.00,100000.00,2,100000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(11,20,'inventario_inicial',3,0,3,50000.00,90000.00,85000.00,150000.00,3,150000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(12,30,'inventario_inicial',3,0,3,70000.00,100000.00,95000.00,210000.00,3,210000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(13,40,'inventario_inicial',1,0,1,70000.00,100000.00,95000.00,70000.00,1,70000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(14,41,'inventario_inicial',1,0,1,65000.00,90000.00,85000.00,65000.00,1,65000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(15,45,'inventario_inicial',1,0,1,50000.00,90000.00,85000.00,50000.00,1,50000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(16,47,'inventario_inicial',2,0,2,65000.00,105000.00,100000.00,130000.00,2,130000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(17,48,'inventario_inicial',3,0,3,70000.00,120000.00,115000.00,210000.00,3,210000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(18,49,'inventario_inicial',2,0,2,50000.00,85000.00,80000.00,100000.00,2,100000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52'),(19,50,'inventario_inicial',2,0,2,45000.00,90000.00,85000.00,90000.00,2,90000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,5,'Inventario inicial — migración automática',NULL,'2026-02-26 03:34:52','2026-02-26 03:34:52');
...
INSERT INTO `tipos_gastos` VALUES (1,'servicios','SERVICIOS (LUZ, AGUA, INTERNET)','activo','2026-02-26 02:13:55'),(2,'arriendo','ARRIENDO/ALQUILER','activo','2026-02-26 02:13:55'),(3,'transporte','TRANSPORTE/DOMICILIOS','activo','2026-02-26 02:13:55'),(4,'compras_suministros','COMPRAS Y SUMINISTROS','activo','2026-02-26 02:13:55'),(5,'nomina','NÓMINA/SALARIOS','activo','2026-02-26 02:13:55'),(6,'publicidad','PUBLICIDAD Y MARKETING','activo','2026-02-26 02:13:55'),(7,'mantenimiento','MANTENIMIENTO','activo','2026-02-26 02:13:55'),(8,'impuestos','IMPUESTOS','activo','2026-02-26 02:13:55'),(9,'servicios_profesionales','SERVICIOS PROFESIONALES','activo','2026-02-26 02:13:55'),(10,'otros','OTROS','activo','2026-02-26 02:13:55');
...
INSERT INTO `tipos_prenda` VALUES (1,1,'PANTALÓN DE VESTIR','Pantalón formal para ocasiones especiales',1,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(2,1,'PANTALÓN CASUAL','Pantalón de uso diario',2,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(3,1,'PANTALÓN CARGO','Pantalón con bolsillos laterales',3,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(4,1,'PANTALÓN PALAZZO','Pantalón amplio de pierna ancha',4,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(5,1,'PANTALÓN CAPRI','Pantalón tres cuartos',5,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(6,1,'LEGGINGS','Pantalón ajustado elástico',6,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(7,1,'JOGGERS','Pantalón deportivo con puño',7,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(8,1,'PANTALÓN ACAMPANADO','Pantalón con bota ancha',8,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(9,1,'PANTALÓN RECTO','Pantalón de corte recto clásico',9,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(10,1,'PANTALÓN PITILLO','Pantalón ajustado tipo skinny',10,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(11,1,'PANTALÓN JEAN','Pantalón de mezclilla/denim',11,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(12,1,'PANTALÓN LINO','Pantalón fresco de lino',12,'activo','2026-01-16 03:26:16','2026-02-26 03:24:43'),(13,2,'BLUSA MANGA LARGA','Blusa con manga completa',1,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(14,2,'BLUSA MANGA CORTA','Blusa con manga corta',2,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(15,2,'BLUSA SIN MANGAS','Blusa tipo chaleco',3,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(16,2,'BLUSA DE ENCAJE','Blusa con detalles de encaje',4,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(17,2,'BLUSA CAMPESINA','Blusa con hombros descubiertos',5,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(18,2,'BLUSA CROP TOP','Blusa corta que deja el abdomen al descubierto',6,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(19,2,'BLUSA OVERSIZE','Blusa holgada de talla grande',7,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(20,2,'BLUSA CON BOTONES','Blusa tipo camisa con botonadura',8,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(21,2,'BLUSA CUELLO V','Blusa con escote en V',9,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(22,2,'BLUSA CUELLO REDONDO','Blusa con cuello circular',10,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(23,2,'BLUSA ESTAMPADA','Blusa con diseños o patrones',11,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(24,2,'BLUSA LISA','Blusa de color sólido sin estampados',12,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(25,2,'BLUSA SATINADA','Blusa de tela satinada brillante',13,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(26,2,'BLUSA TRANSPARENTE','Blusa de tela semi-transparente',14,'activo','2026-01-16 03:26:24','2026-02-26 03:24:43'),(27,4,'FALDA CORTA','Falda mini por encima de la rodilla',1,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(28,4,'FALDA MIDI','Falda a media pierna',2,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(29,4,'FALDA LARGA','Falda maxi hasta los tobillos',3,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(30,4,'FALDA PLISADA','Falda con pliegues',4,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(31,4,'FALDA TUBO','Falda ajustada tipo lápiz',5,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(32,4,'FALDA ACAMPANADA','Falda con vuelo en A',6,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(33,4,'FALDA CON VUELO','Falda circular amplia',7,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(34,4,'FALDA JEAN','Falda de mezclilla',8,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(35,4,'FALDA ASIMÉTRICA','Falda con largo irregular',9,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(36,4,'FALDA RECTA','Falda de corte recto',10,'activo','2026-01-16 03:26:44','2026-02-26 03:24:43'),(37,5,'SHORT JEAN','Short de mezclilla',1,'activo','2026-01-16 03:26:52','2026-02-26 03:24:43'),(38,5,'SHORT DE TELA','Short de tela suave',2,'activo','2026-01-16 03:26:52','2026-02-26 03:24:43'),(39,5,'SHORT DEPORTIVO','Short para actividades deportivas',3,'activo','2026-01-16 03:26:52','2026-02-26 03:24:44'),(40,5,'SHORT CARGO','Short con bolsillos laterales',4,'activo','2026-01-16 03:26:52','2026-02-26 03:24:44'),(41,5,'SHORT BERMUDA','Short largo tipo bermuda',5,'activo','2026-01-16 03:26:52','2026-02-26 03:24:44'),(42,5,'SHORT TIRO ALTO','Short con cintura alta',6,'activo','2026-01-16 03:26:52','2026-02-26 03:24:44'),(43,5,'SHORT TIRO MEDIO','Short con cintura media',7,'activo','2026-01-16 03:26:52','2026-02-26 03:24:44'),(44,5,'SHORT CICLISTA','Short ajustado tipo biker',8,'activo','2026-01-16 03:26:52','2026-02-26 03:24:44'),(45,6,'VESTIDO CASUAL','Vestido de uso diario',1,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(46,6,'VESTIDO DE FIESTA','Vestido elegante para eventos',2,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(47,6,'VESTIDO FORMAL','Vestido de gala o ceremonia',3,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(48,6,'VESTIDO MIDI','Vestido a media pierna',4,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(49,6,'VESTIDO MAXI','Vestido largo hasta los tobillos',5,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(50,6,'VESTIDO CORTO','Vestido mini por encima de la rodilla',6,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(51,6,'VESTIDO CÓCTEL','Vestido semi-formal',7,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(52,6,'VESTIDO CAMISERO','Vestido tipo camisa con botones',8,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(53,6,'VESTIDO TUBO','Vestido ajustado tipo bodycon',9,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(54,6,'VESTIDO PLAYERO','Vestido ligero para playa',10,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(55,6,'VESTIDO ACAMPANADO','Vestido con falda con vuelo',11,'activo','2026-01-16 03:27:01','2026-02-26 03:24:44'),(56,7,'BOLSO DE MANO','Bolso pequeño con asa corta',1,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(57,7,'BOLSO BANDOLERA','Bolso con correa cruzada',2,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(58,7,'BOLSO TOTE','Bolso grande tipo shopping',3,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(59,7,'MOCHILA','Bolso para la espalda',4,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(60,7,'CLUTCH','Bolso de mano pequeño sin asas',5,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(61,7,'BOLSO SHOPPER','Bolso amplio para compras',6,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(62,7,'CARTERA','Billetera o monedero',7,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(63,7,'RIÑONERA','Bolso para la cintura',8,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(64,7,'BOLSO SATCHEL','Bolso estructurado con solapa',9,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(65,7,'BOLSO BUCKET','Bolso tipo cubo con cordón',10,'activo','2026-01-16 03:27:09','2026-02-26 03:24:44'),(74,3,'CONJUNTO DEPORTIVO','Conjunto para actividades deportivas',1,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(75,3,'CONJUNTO CASUAL','Conjunto de uso diario',2,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(76,3,'CONJUNTO DE VESTIR','Conjunto formal elegante',3,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(77,3,'CONJUNTO CROP TOP + FALDA','Conjunto de dos piezas con crop top',4,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(78,3,'CONJUNTO BLUSA + PANTALÓN','Conjunto coordinado de blusa y pantalón',5,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(79,3,'CONJUNTO TOP + SHORT','Conjunto de top y short',6,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(80,3,'CONJUNTO BLAZER + PANTALÓN','Conjunto ejecutivo',7,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(81,3,'CONJUNTO PLAYERO','Conjunto para playa o piscina',8,'activo','2026-02-13 03:41:00','2026-02-26 03:24:44'),(82,10,'PACO CHIQUITO',NULL,0,'activo','2026-02-26 03:11:15','2026-02-26 03:11:15');
...
-- Dump completed on 2026-02-27 16:35:52
