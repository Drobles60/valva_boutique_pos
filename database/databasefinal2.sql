...
INSERT INTO `clientes` VALUES (1,'publico','juan perez','15200000','m8p9q2@menaken.com','3162562916','lote 11 manzana 6 transversal 2B, monte lago',0.00,50000.00,50000.00,'activo','2026-02-07 04:03:38','2026-02-17 19:21:17'),(2,'publico','oscar','21845454','julillain@hotmail.com','3162562916','lote 11 manzana 6 transversal 2B, monte lago',0.00,180000.00,80000.00,'activo','2026-02-07 04:44:02','2026-02-17 19:15:07'),(3,'especial','oscar','000000000','m8p9q2@menaken.com','9999999999','lote 11 manzana 6 transversal 2B, monte lago',0.00,235000.00,105000.00,'activo','2026-02-14 04:48:47','2026-02-17 19:15:07');
...
INSERT INTO `descuento_productos` VALUES (23,9),(25,12);
...
INSERT INTO `descuento_tipos_prenda` VALUES (24,17);
...
INSERT INTO `detalle_pedidos` VALUES (1,2,'pedido de preubea',50,1000000.00),(2,3,'qwe212e',50,1000000.00),(3,4,'dasdasd',40,45222222.00),(4,5,'wqdqwd',18,4500000.00),(5,6,'pedido de perras ',5,1000000.00),(6,7,'articulo',1,15000000.00),(7,8,'jhhjh',12,1500000.00);
...
CREATE TABLE `gastos` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `categoria` enum('servicios','arriendo','transporte','compras_suministros','nomina','publicidad','mantenimiento','impuestos','servicios_profesionales','otros') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Categoría del gasto',
  `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Descripción breve del gasto',
  ...
  `referencia` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Número de factura, comprobante o referencia',
  `notas` text COLLATE utf8mb4_unicode_ci COMMENT 'Observaciones adicionales',
...
INSERT INTO `gastos` VALUES (1,'servicios','pago de la luz',10000.00,'2026-02-17','efectivo',NULL,'fue en x lugar',5,'2026-02-17 23:24:50','2026-02-17 23:24:50'),(2,'servicios','pago agua',50000.00,'2026-02-17','efectivo','no aplica','pague en otro sitio',5,'2026-02-17 23:29:24','2026-02-17 23:29:24');
...
INSERT INTO `sesiones_caja` VALUES (1,1,5,'2026-02-18 04:53:32',NULL,'abierta',50000.00,NULL,NULL,NULL);
...
-- Dump completed on 2026-02-18 22:56:19
