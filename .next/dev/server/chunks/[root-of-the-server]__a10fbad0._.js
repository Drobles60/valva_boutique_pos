...
"[project]/app/api/clientes/[id]/abonos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const cliente = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT id, nombre, saldo_pendiente 
       FROM clientes 
       WHERE id = ? AND estado = 'activo'`, [
            clienteId
        ]);
       ...
       ORDER BY cpc.created_at ASC`, [
        ...
        const clienteActualizado = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])('SELECT saldo_pendiente FROM clientes WHERE id = ?', [
            clienteId
        ]);
        const resultado = {
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a10fbad0._.js.map