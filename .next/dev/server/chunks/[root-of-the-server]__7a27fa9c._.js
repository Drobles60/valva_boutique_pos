...
"[project]/Desktop/valva_boutique_pos/app/api/descuentos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
      ...
      WHERE fecha_fin IS NOT NULL 
        ...
        AND estado = 'activo'
    `);
        const descuentos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
    ...
    `);
        ...
        `, [
                ...
                const tiposPrenda = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
...
async function PUT(request) {
    try {
        const body = await request.json();
        const { id, nombre, descripcion, tipo, valor, fecha_inicio, fecha_fin, estado, aplicable_a, productos_seleccionados, tipos_prenda_seleccionados } = body;
        // Validaciones
    ...
    `, [
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`DELETE FROM descuento_productos WHERE descuento_id = ?`, [
            id
        ]);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`DELETE FROM descuento_tipos_prenda WHERE descuento_id = ?`, [
            id
        ]);
...
async function DELETE(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`DELETE FROM descuentos WHERE id = ?`, [
            id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a27fa9c._.js.map