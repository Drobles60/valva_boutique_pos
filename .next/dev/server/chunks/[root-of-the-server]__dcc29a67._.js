...
"[project]/app/api/reportes/financieros/margenes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const porCategoria = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT 
    ...
    `, [
        ...
        // Peores márgenes
        const peoresProductos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT 
        p.nombre, p.sku,
        COALESCE(cp.nombre, 'Sin categoría') as categoria,
        SUM(dv.cantidad) as unidades,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dcc29a67._.js.map