...
"[project]/Desktop/valva_boutique_pos/app/api/caja/estado/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        let sesion = null;
        try {
            sesion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT sc.id, sc.caja_id, sc.usuario_id, sc.fecha_apertura, sc.monto_base,
         ...
         LIMIT 1`);
            ...
            if (e.message?.includes('monto_base') || e.message?.includes('Unknown column')) {
                sesion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT sc.id, sc.caja_id, sc.usuario_id, sc.fecha_apertura,
                  c.nombre as caja_nombre,
                  u.nombre as usuario_nombre
           FROM sesiones_caja sc
           LEFT JOIN cajas c ON sc.caja_id = c.id
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            message: error.message || 'Error al verificar estado de caja'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50a394d2._.js.map