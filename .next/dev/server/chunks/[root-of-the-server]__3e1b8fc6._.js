...
"[project]/app/api/proveedores/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const proveedores = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, codigo, ruc, razon_social, nombre_comercial, telefono, celular, email,
              direccion, ciudad, provincia, persona_contacto, telefono_contacto,
              estado, created_at, updated_at 
       FROM proveedores 
       ORDER BY created_at DESC`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(proveedores);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const existente = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM proveedores WHERE ruc = ?', [
            ruc
        ]);
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO proveedores (
        ...
        const nuevoProveedor = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, codigo, ruc, razon_social, nombre_comercial, telefono, celular, email,
              direccion, ciudad, provincia, persona_contacto, telefono_contacto,
              estado, created_at, updated_at 
       FROM proveedores 
       WHERE id = ?`, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(nuevoProveedor[0], {
            status: 201
        });
    } catch (error) {
...
async function PUT(request) {
    try {
        ...
        const existente = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM proveedores WHERE ruc = ? AND id != ?', [
            ruc,
            id
        ]);
        if (existente.length > 0) {
       ...
       WHERE id = ?`, [
        ...
        const proveedorActualizado = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, codigo, ruc, razon_social, nombre_comercial, telefono, celular, email,
              direccion, ciudad, provincia, persona_contacto, telefono_contacto,
              estado, created_at, updated_at 
       FROM proveedores 
       WHERE id = ?`, [
...
async function DELETE(request) {
    try {
        ...
        const proveedor = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM proveedores WHERE id = ?', [
            id
        ]);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM proveedores WHERE id = ?', [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e1b8fc6._.js.map