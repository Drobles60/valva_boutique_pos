    ...
    try {
       ...
       ORDER BY id DESC LIMIT 1`);
        ...
        for (const item of productos){
            ...
            const productoActual = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])('SELECT stock_actual, precio_compra, precio_venta, precio_minimo FROM productos WHERE id = ?', [
                item.producto_id
            ]);
