...
function FacturaDialog({ open, onClose, venta }) {
    ...
    const crearPDF = async ()=>{
        try {
            ...
            pdf.text('Moda y Estilo', centerX, yPos, {
                align: 'center'
            });
            yPos += 4;
            // NIT o identificación (centrado)
            pdf.text('NIT: (Por definir)', centerX, yPos, {
                align: 'center'
            });
            yPos += 5;
            // Teléfono (centrado)
            pdf.text('Teléfono', centerX, yPos, {
                align: 'center'
            });
            yPos += 4;
            // Línea separadora
...
function VentasContent() {
    ...
    const finalizarVentaContado = async (data)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$1$2e$7$2e$4_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Error al procesar venta', {
    ...
    const productosFiltrados = productos.filter((p)=>p.cantidad > 0 && // Solo mostrar productos con stock disponible
        (p.nombre.toLowerCase().includes(searchTerm.toLowerCase()) || p.codigo.toLowerCase().includes(searchTerm.toLowerCase()) || p.referencia.toLowerCase().includes(searchTerm.toLowerCase())));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
