...
function DescuentosContent() {
    ...
    const loadProductos = (searchText = "")=>{
        const allProductos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProducts"])();
        if (!searchText.trim()) {
            setProductos([]);
            return;
        }
    ...
    const confirmDelete = async ()=>{
        if (descuentoToDelete) {
            try {
                ...
                if (response.ok) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$1$2e$7$2e$4_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Descuento eliminado');
                    loadDescuentos();
                } else {
...
//# sourceMappingURL=_24cc0e0d._.js.map