...
"[project]/app/api/caja/sesion/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function migrarTabla() {
    try {
        const columnas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SHOW COLUMNS FROM sesiones_caja`);
        const nombres = columnas.map((c)=>c.Field);
        if (!nombres.includes('monto_base')) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`ALTER TABLE sesiones_caja ADD COLUMN monto_base DECIMAL(10,2) DEFAULT 0`);
        }
        if (!nombres.includes('notas_apertura')) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`ALTER TABLE sesiones_caja ADD COLUMN notas_apertura TEXT`);
        }
        if (!nombres.includes('efectivo_contado')) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`ALTER TABLE sesiones_caja ADD COLUMN efectivo_contado DECIMAL(10,2) DEFAULT NULL`);
        }
        if (!nombres.includes('notas_cierre')) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`ALTER TABLE sesiones_caja ADD COLUMN notas_cierre TEXT`);
        }
        // Asegurar que estado tenga DEFAULT
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`ALTER TABLE sesiones_caja MODIFY COLUMN estado VARCHAR(30) DEFAULT 'abierta'`);
    } catch (e) {
...
async function POST(request) {
    try {
        ...
        const sesionExistente = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT id FROM sesiones_caja WHERE estado = 'abierta' LIMIT 1`);
        if (sesionExistente) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        let caja = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT id FROM cajas WHERE estado = 'activa' LIMIT 1`);
        if (!caja) {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO cajas (nombre, codigo, estado) VALUES ('Caja Principal', 'CAJA-01', 'activa')`);
            caja = {
                id: result.insertId
            };
        }
        // Obtener usuario_id
        const usuario = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])('SELECT id FROM usuarios WHERE email = ?', [
            session.user.email
        ]);
        const usuario_id = usuario?.id || null;
        // Crear sesión de caja
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO sesiones_caja (caja_id, usuario_id, fecha_apertura, estado, monto_base, notas_apertura)
       VALUES (?, ?, NOW(), 'abierta', ?, ?)`, [
            caja.id,
            usuario_id,
            monto_base,
...
async function PUT(request) {
    try {
        ...
        const sesion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT id FROM sesiones_caja WHERE estado = 'abierta' LIMIT 1`);
        if (!sesion) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        // Cerrar la sesión
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE sesiones_caja 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68dd80bf._.js.map