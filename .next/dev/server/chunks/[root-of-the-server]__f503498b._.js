...
"[project]/app/api/gastos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const usuarioResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM usuarios WHERE email = ?', [
            session.user.email
        ]);
        ...
        // Insertar el gasto
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO gastos (
        categoria,
        descripcion,
        monto,
        fecha_gasto,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f503498b._.js.map