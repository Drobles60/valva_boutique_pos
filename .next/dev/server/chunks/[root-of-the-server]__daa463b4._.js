...
"[project]/app/api/usuarios/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const usuarios = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, username, email, nombre, apellido, telefono, rol, estado, 
              ultimo_acceso, created_at, updated_at 
       FROM usuarios 
       ORDER BY created_at DESC`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(usuarios);
    } catch (error) {
...
async function POST(request) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$check$2d$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])('usuarios.crear');
        ...
        const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])('SELECT id FROM usuarios WHERE username = ? OR email = ?', [
            username,
            email
        ]);
        if (existingUser) {
        ...
        // Insertar usuario
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO usuarios (username, email, password_hash, nombre, apellido, telefono, rol, estado)
       VALUES (?, ?, ?, ?, ?, ?, ?, 'activo')`, [
            username,
            email,
            password_hash,
        ...
        const nuevoUsuario = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT id, username, email, nombre, apellido, telefono, rol, estado, created_at 
       FROM usuarios WHERE id = ?`, [
            result.insertId
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(nuevoUsuario, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__daa463b4._.js.map