...
"[project]/app/api/pedidos/[id]/abonos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const pedido = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, numero_pedido, costo_total, total_abonado, saldo_pendiente
       FROM pedidos
       WHERE id = ?`, [
            pedidoId
        ]);
        ...
        const pedidoActualizado = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, numero_pedido, costo_total, total_abonado, saldo_pendiente
       FROM pedidos
       WHERE id = ?`, [
            pedidoId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3bcaf544._.js.map