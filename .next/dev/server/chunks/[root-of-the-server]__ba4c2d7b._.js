...
"[project]/Desktop/valva_boutique_pos/app/api/clientes/cuentas-por-cobrar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
      ...
      ORDER BY saldo_pendiente DESC, c.nombre ASC`, []);
        ...
        if (debug) {
            const clientesConDetalle = await Promise.all(clientes.map(async (cliente)=>{
                const facturas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
              cpc.id,
              v.numero_venta,
              cpc.monto_total,
              cpc.saldo_pendiente,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba4c2d7b._.js.map