...
"[project]/app/api/reportes/estadisticas/rotacion/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const productosVendidos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT 
    ...
    `, params);
        ...
        const rotacionCategoria = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT 
        COALESCE(cp.nombre, 'Sin categoría') as categoria,
    ...
    `, params);
        ...
        const categorias = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT id, nombre FROM categorias_padre WHERE estado = 'activo' ORDER BY nombre
    `);
        // Procesamiento
        const conVentas = productosVendidos.filter((p)=>Number(p.cantidadVendida) > 0);
        const sinVentas = productosVendidos.filter((p)=>Number(p.cantidadVendida) === 0);
        // Clasificar rotación
        const clasificar = (prod)=>{
        ...
        const productos = productosVendidos.map((p)=>({
                id: p.id,
                nombre: p.nombre,
                sku: p.sku,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__512a9964._.js.map