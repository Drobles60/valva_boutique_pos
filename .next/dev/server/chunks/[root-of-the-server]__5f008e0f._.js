...
"[project]/app/api/caja/estado/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        let sesion = null;
        try {
            sesion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT sc.id, sc.caja_id, sc.usuario_id, sc.fecha_apertura, sc.monto_base,
         ...
         LIMIT 1`);
            ...
            if (e.message?.includes('monto_base') || e.message?.includes('Unknown column')) {
                sesion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryOne"])(`SELECT sc.id, sc.caja_id, sc.usuario_id, sc.fecha_apertura,
                  c.nombre as caja_nombre,
                  u.nombre as usuario_nombre
           FROM sesiones_caja sc
           LEFT JOIN cajas c ON sc.caja_id = c.id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f008e0f._.js.map