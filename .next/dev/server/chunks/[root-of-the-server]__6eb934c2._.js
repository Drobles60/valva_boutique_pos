...
async function getDescuentosForProduct(productoId) {
    ...
    `, [
        ...
        if (descuentosProducto.length > 0) {
            console.log(`[DESCUENTOS] Detalles:`, descuentosProducto.map((d)=>({
                    id: d.id,
                    nombre: d.nombre,
                    tipo: d.tipo,
                    valor: d.valor
      ...
      `, [
            ...
            if (descuentosTipoPrenda.length > 0) {
                console.log(`[DESCUENTOS] Detalles:`, descuentosTipoPrenda.map((d)=>({
                        id: d.id,
                        nombre: d.nombre,
                        tipo: d.tipo,
                        valor: d.valor
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6eb934c2._.js.map