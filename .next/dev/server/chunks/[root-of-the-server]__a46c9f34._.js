...
"[project]/Desktop/valva_boutique_pos/lib/barcode-generator.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Desktop/valva_boutique_pos/app/api/productos/generar-codigos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$barcode$2d$generator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/valva_boutique_pos/lib/barcode-generator.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const categoriaResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT nombre FROM categorias_padre WHERE id = ? AND estado = 'activo'", [
            categoria_padre_id
        ]);
        const tipoPrendaResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT nombre FROM tipos_prenda WHERE id = ? AND estado = 'activo'", [
            tipo_prenda_id
        ]);
        const tallaResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT valor FROM tallas WHERE id = ? AND estado = 'activo'", [
            talla_id
        ]);
        ...
        const skuPrefix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$barcode$2d$generator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateSKUPrefix"])(categoriaResult[0].nombre, tipoPrendaResult[0].nombre, tallaResult[0].valor);
        // Obtener la secuencia para el SKU (Ãºltimo nÃºmero + 1) usando el prefijo exacto
        const secuenciaResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT MAX(CAST(SUBSTRING_INDEX(sku, '-', -1) AS UNSIGNED)) as max_secuencia
       FROM productos
       WHERE sku LIKE CONCAT(?, '-%')
        ...
        const ultimoCodigoResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT CAST(codigo_barras AS UNSIGNED) as codigo_numero
       FROM productos 
       ...
       LIMIT 1`);
        ...
        // Generar cÃ³digos
        const sku = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$valva_boutique_pos$2f$lib$2f$barcode$2d$generator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateSKU"])(categoriaResult[0].nombre, tipoPrendaResult[0].nombre, tallaResult[0].valor, secuencia);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a46c9f34._.js.map