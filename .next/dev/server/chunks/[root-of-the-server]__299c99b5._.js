...
"[project]/app/api/compras/[id]/confirmar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const [compra] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT c.*, p.razon_social AS proveedor_nombre
       FROM compras c
       ...
       WHERE c.id = ?`, [
        ...
        if (compra.estado !== 'borrador') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: `La compra ya está ${compra.estado}`
        }, {
            status: 400
        });
        // 2. Obtener detalle con precios actuales del producto
        const detalle = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT cd.*, pr.stock_actual, pr.nombre AS producto_nombre,
       ...
       WHERE cd.compra_id = ?`, [
        ...
        if (!detalle.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
        ...
        for (const item of detalle){
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE productos SET stock_actual = ?, precio_compra = ? WHERE id = ?', [
                stockNuevo,
                costoUnit,
                item.producto_id
            ]);
        ...
        // 4. Confirmar compra
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("UPDATE compras SET estado='confirmada' WHERE id=?", [
            id
        ]);
        // 5. Marcar pedido asociado como recibido (buscar por nota que contiene el numero_compra)
        try {
            const pedidosAsociados = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id FROM pedidos WHERE notas LIKE ? AND estado = 'pendiente' LIMIT 1`, [
                `%${compra.numero_compra}%`
            ]);
            if (pedidosAsociados.length > 0) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE pedidos SET estado = 'recibido', fecha_recibido = NOW() WHERE id = ?`, [
                    pedidosAsociados[0].id
                ]);
            }
        } catch (pedErr) {
            console.error('Error al marcar pedido como recibido:', pedErr);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__299c99b5._.js.map