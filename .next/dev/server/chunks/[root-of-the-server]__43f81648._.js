...
"[project]/lib/descuentos.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getDescuentosForProduct(productoId) {
    ...
    `);
        ...
        const producto = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
    ...
    `, [
        ...
        const descuentosProducto = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT d.* 
      FROM descuentos d
    ...
    `, [
        ...
        if (prod.tipo_prenda_id) {
            const descuentosTipoPrenda = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
        SELECT d.*
        FROM descuentos d
...
async function getProductosConDescuentos() {
    try {
        const productos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT p.*, 
...
"[project]/lib/producto-validations.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/productos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$descuentos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/descuentos.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$producto$2d$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/producto-validations.ts [app-route] (ecmascript)");
;
;
;
;
async function GET() {
    ...
    `);
        ...
        const productosConDescuentos = await Promise.all(productos.map(async (producto)=>{
            const descuentos = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$descuentos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDescuentosForProduct"])(producto.id);
            const { precioFinal, descuentoAplicado, montoDescuento } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$descuentos$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calcularPrecioConDescuento"])(producto.precio_venta, descuentos);
...
async function POST(request) {
    try {
        ...
        const nombreLimpio = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$producto$2d$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizeNombreProducto"])(nombre).trim();
        const colorLimpio = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$producto$2d$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sanitizeColorProducto"])(color || '').trim();
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$producto$2d$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isNombreProductoValido"])(nombreLimpio)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$producto$2d$validations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isColorProductoValido"])(colorLimpio)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43f81648._.js.map